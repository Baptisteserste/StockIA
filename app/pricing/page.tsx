    ...
    const tiers = [
        {
            name: "Gratuit",
            price: "0€",
            description: "Pour tester l'analyse de sentiment.",
            features: [
                "10 analyses de stocks / jour",
        ...
        },
        {
            ...
            price: "14.99€",
            period: "/mois",
            description: "Accédez à la puissance totale des agents de trading.",
            features: [
                "Analyses illimitées",
                "Bot PREMIUM (GPT-4o/Claude)",
                "Bot ALGO (Stratégies Pros)",
                "Simulations jusqu'à 30 jours",
                "Analyse Reddit & Sentiment Social",
